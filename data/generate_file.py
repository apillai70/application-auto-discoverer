...
def process_network_edges(df_in: pd.DataFrame, args) -> pd.DataFrame:
    ...
    for _, r in df_in.iterrows():
        ...
        if not app_name:
            ...
            app_name = input_path.stem.replace("template-", "").replace("App_Code_", "").replace("_", " ").title()
...
def main():
    ...
    try:
        ...
        df_processed = process_network_edges(df_input, args)
