...
**Analysis Date:** 2025-09-18 14:27:32
**Source Data:** data_staging\XECHK_complete_archetype_normalized_20250918_141834.csv
...
- UDP: 856 connections (25.8%)
- HTTPS: 812 connections (24.4%)
- HTTP: 793 connections (23.9%)
...
- **Protocols:** 1 different protocols
- **Components:** 1 unique destinations
- **Total Traffic:** 95,143 bytes (0.1 MB)
...
- **Protocols:** 1 different protocols
- **Components:** 1 unique destinations
- **Total Traffic:** 172,725 bytes (0.2 MB)
...
- **HTTPS:** 1,221 connections (24.4%)
- **TCP:** 862 connections (17.2%)
- **UDP:** 856 connections (17.1%)
- **POSTGRESQL:** 426 connections (8.5%)
...
- **Total Traffic Volume:** 16,819,171,790 bytes (15.66 GB)
- **Average per Connection:** 3,363,834 bytes
- **Largest Single Connection:** 10,972,850 bytes
...
### SyntheticApp_1675 - Composite Architecture

**Web Layer**
- Evidence: 1 HTTP/HTTPS connections

### SyntheticApp_1676 - Composite Architecture
